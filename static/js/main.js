...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const rerollBtn = document.getElementById('rerollBtn'); // Get the re-roll button
    ...
    if (generateBtn) {
        generateBtn.addEventListener('click', async () => {
            ...
            if(rerollBtn) rerollBtn.style.display = 'none'; // Hide re-roll during generation too
            ...
            try {
                ...
                // We will show the re-roll button only if results are successfully displayed
            }
        });
    }
});
